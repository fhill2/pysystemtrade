...
def build_and_write_roll_calendar_daily(
    instrument_code,
    ...
    # prices.get_prices_at_frequency_for_instrument()
    # instead of prices.get_merged_prices_for_instrument()
...
if __name__ == "__main__":
    ...
    build_and_write_roll_calendar(instrument_code, output_datapath="/home/f1/")
